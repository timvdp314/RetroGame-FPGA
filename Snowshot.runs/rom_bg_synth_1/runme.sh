...
HD_PWD='C:/Users/busra/Documents/Documenten/Leerjaar 2/Blok 7/RETROGAME_GIT/RetroGame-FPGA/Snowshot.runs/rom_bg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_bg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_bg.tcl
