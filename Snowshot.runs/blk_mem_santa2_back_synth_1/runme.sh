...
HD_PWD='C:/Xilinx/Projects/RetroGame-FPGA/RetroGame-FPGA/Snowshot.runs/blk_mem_santa2_back_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_santa2_back.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_santa2_back.tcl
