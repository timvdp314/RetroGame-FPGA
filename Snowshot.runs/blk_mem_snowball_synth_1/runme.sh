...
HD_PWD='C:/Users/busra/Documents/Documenten/Leerjaar 2/Blok 7/RETROGAME_GIT_NEW/RetroGame-FPGA/Snowshot.runs/blk_mem_snowball_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_snowball.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_snowball.tcl
