...
HD_PWD='C:/Xilinx/Projects/RetroGame-FPGA/RetroGame-FPGA/Snowshot.runs/blk_mem_santa1_right_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_santa1_right.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_santa1_right.tcl
