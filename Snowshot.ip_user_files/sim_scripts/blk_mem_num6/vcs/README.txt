...
#
# Generated by export_simulation on Sat Apr 02 13:04:56 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_num6.sh' script.

./blk_mem_num6.sh -reset_run
...
./blk_mem_num6.sh -noclean_files

For more information on the script, please type './blk_mem_num6.sh -help'.
