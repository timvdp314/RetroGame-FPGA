...
#
# Generated by export_simulation on Thu Apr 07 15:38:08 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_santa1_left.sh' script.

./blk_mem_santa1_left.sh -reset_run
...
./blk_mem_santa1_left.sh -noclean_files

For more information on the script, please type './blk_mem_santa1_left.sh -help'.
