...
#
# Generated by export_simulation on Sat Apr 02 13:22:33 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_santa_2_back.sh' script.

./blk_mem_santa_2_back.sh -reset_run
...
./blk_mem_santa_2_back.sh -noclean_files

For more information on the script, please type './blk_mem_santa_2_back.sh -help'.
