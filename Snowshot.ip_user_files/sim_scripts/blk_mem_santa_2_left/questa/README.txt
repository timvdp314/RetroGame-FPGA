...
#
# Generated by export_simulation on Sat Apr 02 13:23:54 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_santa_2_left.sh' script.

./blk_mem_santa_2_left.sh -reset_run
...
./blk_mem_santa_2_left.sh -noclean_files

For more information on the script, please type './blk_mem_santa_2_left.sh -help'.
