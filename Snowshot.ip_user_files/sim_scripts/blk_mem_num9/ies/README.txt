...
#
# Generated by export_simulation on Sat Apr 02 13:09:30 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_num9.sh' script.

./blk_mem_num9.sh -reset_run
...
./blk_mem_num9.sh -noclean_files

For more information on the script, please type './blk_mem_num9.sh -help'.
