...
#
# Generated by export_simulation on Sat Apr 02 15:04:38 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_snowball.sh' script.

./blk_mem_snowball.sh -reset_run
...
./blk_mem_snowball.sh -noclean_files

For more information on the script, please type './blk_mem_snowball.sh -help'.
