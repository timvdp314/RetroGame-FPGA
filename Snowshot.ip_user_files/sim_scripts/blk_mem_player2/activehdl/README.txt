...
#
# Generated by export_simulation on Wed Mar 09 19:20:32 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_player2.sh' script.

./blk_mem_player2.sh -reset_run
...
./blk_mem_player2.sh -noclean_files

For more information on the script, please type './blk_mem_player2.sh -help'.
