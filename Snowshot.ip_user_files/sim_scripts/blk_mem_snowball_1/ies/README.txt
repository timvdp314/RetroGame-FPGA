...
#
# Generated by export_simulation on Wed Mar 09 16:10:15 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_snowball_1.sh' script.

./blk_mem_snowball_1.sh -reset_run
...
./blk_mem_snowball_1.sh -noclean_files

For more information on the script, please type './blk_mem_snowball_1.sh -help'.
