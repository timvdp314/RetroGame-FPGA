...
#
# Generated by export_simulation on Sat Apr 02 13:21:00 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_santa_1_right.sh' script.

./blk_mem_santa_1_right.sh -reset_run
...
./blk_mem_santa_1_right.sh -noclean_files

For more information on the script, please type './blk_mem_santa_1_right.sh -help'.
