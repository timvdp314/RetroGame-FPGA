...
#
# Generated by export_simulation on Sat Apr 02 13:04:07 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_num5.sh' script.

./blk_mem_num5.sh -reset_run
...
./blk_mem_num5.sh -noclean_files

For more information on the script, please type './blk_mem_num5.sh -help'.
