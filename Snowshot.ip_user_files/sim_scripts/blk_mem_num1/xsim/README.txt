...
#
# Generated by export_simulation on Sat Apr 02 12:59:18 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_num1.sh' script.

./blk_mem_num1.sh -reset_run
...
./blk_mem_num1.sh -noclean_files

For more information on the script, please type './blk_mem_num1.sh -help'.
