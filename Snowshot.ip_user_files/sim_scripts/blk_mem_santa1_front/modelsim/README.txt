...
#
# Generated by export_simulation on Sat Apr 02 14:59:07 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_santa1_front.sh' script.

./blk_mem_santa1_front.sh -reset_run
...
./blk_mem_santa1_front.sh -noclean_files

For more information on the script, please type './blk_mem_santa1_front.sh -help'.
